...
import { RulerDimensionLine, Star, Home } from 'lucide-react'
          ...
          {imageError ? (
            ...
            <div className="w-full h-48 bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center">
              <div className="text-center">
                <Home className="w-12 h-12 text-teal-400 mx-auto mb-2" />
                <p className="text-sm text-teal-600 font-medium">{propertyType.toUpperCase()}</p>
                <p className="text-xs text-teal-500">No image available</p>
              </div>
            </div>
          ) : (
            <Image
